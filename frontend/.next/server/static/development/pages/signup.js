...
var _jsxFileName = "C:\\Users\\Other User\\Desktop\\fullStackProjects\\letswatch\\letswatch2.0\\frontend\\components\\Signup.js";
...
var FormContainer = styled_components__WEBPACK_IMPORTED_MODULE_4___default.a.div.withConfig({
  displayName: "Signup__FormContainer",
  componentId: "grug68-0"
})(["form{max-width:", ";margin:auto;padding:20px;color:", ";text-align:center;}fieldset{border:1px solid ", ";}input{border:1px solid ", ";}button{background-color:white;padding:1rem 2rem;margin-top:20px;margin-bottom:20px;color:", ";border:1px solid ", ";border-radius:10px;}button:hover{background-color:", ";color:white;cursor:pointer;}"], function (props) {
  return props.theme.maxWidth;
}, function (props) {
  return props.theme.mainColor;
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FormContainer, {
          ...
          __self: this
        }, "Sign Up For an Account"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ErrorMessage__WEBPACK_IMPORTED_MODULE_7__["default"], {
          error: error,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 80
...
var _jsxFileName = "C:\\Users\\Other User\\Desktop\\fullStackProjects\\letswatch\\letswatch2.0\\frontend\\pages\\signup.js";
