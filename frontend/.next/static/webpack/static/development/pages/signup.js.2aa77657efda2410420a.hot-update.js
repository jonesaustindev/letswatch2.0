...
})(["form{max-width:", ";margin:auto;padding:20px;color:", ";text-align:center;border:1px solid ", ";}input{border:1px solid ", ";}button{background-color:white;padding:1rem 2rem;margin-top:20px;margin-bottom:20px;color:", ";border:1px solid ", ";border-radius:10px;}"], function (props) {
...
//# sourceMappingURL=signup.js.2aa77657efda2410420a.hot-update.js.map