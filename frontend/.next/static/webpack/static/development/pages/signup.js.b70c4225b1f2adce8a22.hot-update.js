...
})(["form{max-width:", ";margin:auto;padding:20px;color:", ";text-align:center;}fieldset{border:1px solid ", ";}input{border:1px solid ", ";}button{background-color:white;padding:1rem 2rem;margin-top:20px;margin-bottom:20px;color:", ";border:1px solid ", ";border-radius:10px;}button:hover{background-color:", ";color:white;}"], function (props) {
...
//# sourceMappingURL=signup.js.b70c4225b1f2adce8a22.hot-update.js.map