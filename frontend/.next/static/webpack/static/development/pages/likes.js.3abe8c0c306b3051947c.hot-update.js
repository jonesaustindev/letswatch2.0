...
})(["max-height:445px;width:300px;overflow:hidden;background:#000;box-shadow:", ";margin-top:20px;margin-bottom:20px;.movie-card .poster{position:relative;overflow:hidden;}.movie-details{position:absolute;padding:20px;width:100%;height:100%;bottom:-450px;left:0;box-sizing:border-box;transition:0.7s;z-index:2;color:#f7f7f7;}.movie-card .poster:before{position:absolute;content:'';bottom:-300px;left:0;width:100%;height:100%;background:linear-gradient(0deg,#000 40%,transparent);transition:0.5s;z-index:1;}.movie-card:hover .poster:before{bottom:0;}.movie-card .poster img{width:100%;transition:0.5s;}.movie-card:hover .poster img{filter:blur(2px);transform:translateY(-40px);}.movie-card:hover .movie-details{bottom:0;}.movie-details h3{margin:0;padding:0;padding-bottom:5px;font-size:1.2rem;font-weight:700;}.movie-details h5{font-size:1.1rem;}.movie-details h6{font-size:1rem;}.movie-card p{font-size:0.9rem;}.movie-card-overview{padding-top:18px;}.movie-card-overview p{margin-bottom:2px;}.view-more{text-decoration:none;color:#f7f7f7;}.view-more:hover{color:#f7f7f7;}"], function (props) {
...
//# sourceMappingURL=likes.js.3abe8c0c306b3051947c.hot-update.js.map